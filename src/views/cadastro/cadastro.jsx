                ...
                <form onSubmit={handleSubmit(onSubmit)} className="p-1 rounded-lg shadow-lg w-5/6">
                    ...
                    <div class="col-span-full">
                        ...
                        <div class="mt-1 flex items-center gap-x-3">
                            ...
                            <button type="button" class="rounded-md bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50">Alterar</button>
                        </div>
                    </div>
